...
config_def = {
    ...
    "misc": {
        ...
        "program_version": (("wstring",), ("Qman 1.4.1-69-gb1267c7",), False, "Formal program name and version"),
        ...
        "viewer_path": (("string",), ("/usr/bin/xdg-open",), True, "Path to file/directory viewer"),
        ...
        "reset_after_viewer": (("bool",), ("true",), True, "Re-initialize curses after viewing a file or directory"),
