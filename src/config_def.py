...
config_def = {
    "tcap": {
        "colours": (
            ...
            ("-1",),
            True,
            "Number of colors supported by the terminal (set to -1 to auto-configure)",
        ),
    ...
    "chars": {
        ...
        "trans_mode_name": (
            ...
            ("│",),
            True,
            "Transition between the mode to name sections of the status bar",
        ),
        "trans_name_loc": (
            ("wstring",),
            ("│",),
        ...
        "trans_prompt_em": (
            ...
            (" ",),
            True,
            "Transition between the prompt and error message sections of the status bar",
        ),
    ...
    "colours": {
        ...
        "link_ls": (
            ...
            ("cyan", "black", "false"),
            True,
            "In-page local search links",
        ),
        "link_ls_f": (
            ("colour",),
            ("black", "cyan", "false"),
            True,
            "In-page local search links (focused)",
        ),
        "sb_line": (
            ("colour",),
            ("yellow", "black", "true"),
        ...
        "toc_text": (
            ...
            ("cyan", "black", "false"),
            True,
            "TOC dialog entries text",
        ),
        "toc_text_f": (
            ("colour",),
            ("black", "cyan", "false"),
            True,
            "TOC dialog entries text (focused)",
        ),
        "trans_mode_name": (
            ("int", 0, 65535),
            ("0",),
            False,
            "Color pair for mode to name transition character",
        ),
        "trans_name_loc": (
            ("int", 0, 65535),
            ("0",),
            False,
            "Color pair for name to location transition character",
        ),
        "trans_prompt_help": (
            ("int", 0, 65535),
            ("0",),
            False,
            "Color pair for prompt to help transition character",
        ),
        "trans_prompt_em": (
            ("int", 0, 65535),
            ("0",),
            False,
            "Color pair for prompt to error_message transition character",
        ),
    },
    "keys": {
    ...
    "mouse": {
        ...
        "left_click_open": (
            ...
            ("false",),
            True,
            "Causes the left mouse button to invoke the OPEN action and/or act as the ENTER key",
        ),
    },
    "layout": {
        "tui": (
            ...
            ("true",),
            False,
            "True if we are in TUI mode, false if we are in CLI mode",
        ),
        "fixedwidth": (
            ("bool",),
            ("true",),
            False,
            "If true, don't change width to match the terminal size",
        ),
        ...
        "imm_width_narrow": (
            ...
            ("54",),
            False,
            "Narrow pop-up dialogs width",
        ),
        "imm_width_wide": (
            ("int", 0, 400),
            ("54",),
            False,
            "Wide pop-up dialogs width",
        ),
        "imm_height_short": (
            ("int", 0, 100),
            ("6",),
            False,
            "Short pop-up dialogs height",
        ),
        "imm_height_long": (
            ("int", 0, 100),
            ("10",),
            False,
            "Long pop-up dialogs height",
        ),
        "sections_on_top": (
            ("bool",),
            ("true",),
            True,
            "If true, show a list of sections at the top of each page",
        ),
        ...
        "tabstop": (
            ...
            ("8",),
            True,
            "Number of characters in a tab stop",
        ),
    ...
    "misc": {
        "program_name": (
            ...
            None,
            False,
            "Program executable basename (discovered automatically)",
        ),
        "program_version": (
            ("wstring",),
            ("Qman 1.4.1-48-g13b0b9d",),
            False,
            "Formal program name and version",
        ),
        "system_type": (
            ("systype",),
            ("mandb",),
            True,
            "System type: mandb, mandoc, or freebsd",
        ),
        "config_path": (("string",), None, False, "Path to the configuration file"),
        "man_path": (
            ("string",),
            ("/opt/homebrew/bin/gman",),
            True,
            "Path to the man(1) command",
        ),
        "groff_path": (
            ("string",),
            ("/opt/homebrew/bin/groff",),
            True,
            "Path to the groff(1) command",
        ),
        "whatis_path": (
            ("string",),
            ("/opt/homebrew/bin/gwhatis",),
            True,
            "Path to the whatis(1) command",
        ),
        "apropos_path": (
            ("string",),
            ("/opt/homebrew/bin/gapropos",),
            True,
            "Path to the apropos(1) command",
        ),
        "browser_path": (
            ("string",),
            ("/usr/bin/open",),
            True,
            "Path to web browser command",
        ),
        "mailer_path": (
            ("string",),
            ("/usr/bin/email",),
            True,
            "Path to mailer command",
        ),
        "reset_after_http": (
            ("bool",),
            ("true",),
        ...
        "global_apropos": (
            ...
            ("false",),
            False,
            "-k / --global-whatis option was passed",
        ),
    },
}
