...
config_def = {
    ...
    "colours": {
        ...
        "link_email": (("colour",), ("magenta", "default", "false"), True, "E-mail links"),
        "link_email_f": (("colour",), ("black", "magenta", "false"), True, "E-mail links (focused)"),
        "link_file": (("colour",), ("blue", "default", "false"), True, "File links"),
        "link_file_f": (("colour",), ("black", "blue", "false"), True, "File links (focused)"),
        "link_ls": (("colour",), ("cyan", "default", "false"), True, "In-page local search links"),
        "link_ls_f": (("colour",), ("black", "cyan", "false"), True, "In-page local search links (focused)"),
        "sb_line": (("colour",), ("yellow", "default", "true"), True, "Scrollbar track line"),
        "sb_block": (("colour",), ("yellow", "default", "true"), True, "Scrollbar knob"),
        "stat_indic_mode": (("colour",), ("white", "red", "true"), True, "Status bar mode section"),
        ...
        "stat_input_prompt": (("colour",), ("default", "default", "false"), True, "Status bar input prompt"),
        "stat_input_help": (("colour",), ("yellow", "default", "true"), True, "Status bar help section"),
        "stat_input_em": (("colour",), ("red", "default", "true"), True, "Status bar error message section"),
        "imm_border": (("colour",), ("yellow", "default", "true"), True, "Pop-up dialogs border"),
        "imm_title": (("colour",), ("white", "red", "true"), True, "Pop-up dialogs title"),
        "sp_input": (("colour",), ("default", "default", "false"), True, "Pop-up input dialog prompt"),
        "sp_text": (("colour",), ("cyan", "default", "false"), True, "Pop-up input dialog incremental search text"),
        "sp_text_f": (("colour",), ("default", "default", "true"), True, "Pop-up input dialog incremental search text (focused)"),
        "help_text": (("colour",), ("cyan", "default", "false"), True, "Help dialog entries text"),
        "help_text_f": (("colour",), ("default", "default", "true"), True, "Help dialog entries text (focused)"),
        "history_text": (("colour",), ("cyan", "default", "false"), True, "History dialog entries text"),
        "history_text_f": (("colour",), ("default", "default", "true"), True, "History dialog entries text (focused)"),
        "toc_text": (("colour",), ("cyan", "default", "false"), True, "TOC dialog entries text"),
        "toc_text_f": (("colour",), ("default", "default", "true"), True, "TOC dialog entries text (focused)"),
    ...
    "misc": {
        ...
        "program_version": (("wstring",), ("Qman 1.5.0-41-gdfe6c6a",), False, "Formal program name and version"),
